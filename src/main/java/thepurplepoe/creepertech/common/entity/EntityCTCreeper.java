...
import thepurplepoe.creepertech.common.entity.ai.EntityAICTCreeperSwell;

public class EntityCTCreeper extends EntityMob
{
    private static final DataParameter<Integer> STATE = EntityDataManager.<Integer>createKey(EntityCTCreeper.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> IGNITED = EntityDataManager.<Boolean>createKey(EntityCTCreeper.class, DataSerializers.BOOLEAN);
    /**
    ...
    protected float fuseDistance = 3;
    protected float defuseDistance = 7;
    private int droppedSkulls;

    public EntityCTCreeper(World worldIn)
    {
        super(worldIn);
